...
public class Exercise05 {
    ...
    public static void checkLessOrGreaterEqual(int n1, int n2) {
        System.out.println(n1 < n2 ? n1 + " es menor que " + n2 : n1 + " es mayor o igual que " + n2);
    }
    ...
    public static void checkMultiply(int n1, int n2) {
        System.out.println(n1 % n2 == 0 ? n1 + " es multiplo de " + n2 : n1 + " no es multiplo de " + n2);
    }
    ...
    public static void checkPositiveNegative(int num) {
        System.out.println(num < 0 ? num + " es negativo." : num + " es positivo.");
    }
}
